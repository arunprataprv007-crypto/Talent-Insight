...
import { BrainCircuit, Briefcase, Users, LayoutDashboard, GitMerge, LogOut, Loader2, Search, Sparkles, X, Globe, ClipboardList, Code2, GraduationCap, MessageCircle } from "lucide-react";
